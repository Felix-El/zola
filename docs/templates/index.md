...
[Get started]({{ get_url(path='@/documentation/_index.md') }})
...
[documentation]({{ get_url(path='@/documentation/_index.md') }}) and see for yourself.
...
Zola comes with [shortcodes]({{ get_url(path='@/documentation/content/shortcodes.md') }}) and
[internal links]({{ get_url(path='@/documentation/content/linking.md') }})
